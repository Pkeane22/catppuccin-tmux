...
main() {
  ...
  RATE=$(get_tmux_option "@catppuccin_refresh_rate" 5)
  cpu_load=$(get_tmux_option "@catppuccin_cpu_display_load" false)
  cpu_label=$(get_tmux_option "@catppuccin_cpu_usage_label" "")
